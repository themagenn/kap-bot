...
USERS = ["@NebulaHerbs", "@vnasyvn1", "@HayBro420", "@ProfessorElina", "@Bambinopapi2", "@puff_yvn13", "@GLOBALyvn", "@criminalape", "@toopac420", "@Sherlockstore420","@GusFringEVN", "@taaffo", "@Big_Bong_Shop"]
